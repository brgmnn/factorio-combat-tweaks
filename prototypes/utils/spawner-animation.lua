-- local function spawner_integration()
-- return
--   {
...
local function spawner_idle_animation(variation, tint)
  return {
    layers = {
      ...
      {
        filename = "__combat-tweaks__/graphics/entity/spawner/spawner-idle-mask.png",
        flags = { "mask" },
        width = 140,
        height = 118,
        frame_count = 8,
        ...
        y = variation * 118 * 2,
        hr_version = {
          filename = "__combat-tweaks__/graphics/entity/spawner/hr-spawner-idle-mask.png",
          flags = { "mask" },
          width = 276,
          height = 234,
          frame_count = 8,
...
local function spawner_die_animation(variation, tint)
  return {
    layers = {
      {
      ...
      {
        filename = "__combat-tweaks__/graphics/entity/spawner/spawner-die-mask.png",
        flags = { "mask" },
        width = 140,
        height = 118,
        frame_count = 8,
        ...
        y = variation * 118,
        hr_version = {
          filename = "__combat-tweaks__/graphics/entity/spawner/hr-spawner-die-mask.png",
          flags = { "mask" },
          width = 276,
          height = 234,
          frame_count = 8,
...
return {
  -- spawner_integration = spawner_integration,
  spawner_idle_animation = spawner_idle_animation,
  spawner_die_animation = spawner_die_animation
}
